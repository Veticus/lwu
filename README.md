...
**NOTE: This isn't ready for use yet. So far i've got the "tricky" bits working (The parsing, enumeration and arg handling). The next step is to combine things into something working.**
